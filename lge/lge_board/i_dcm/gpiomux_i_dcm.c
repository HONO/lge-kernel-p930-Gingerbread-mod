...
/* kwangdo.yi@lge.com [jointlab] Wed 30 Mar 2011 S
   add i_atnt gpio suspend/active config
*/
#ifdef CONFIG_LGE_I_POWER_REVB_GPIO
#include "gpiomux_p930.h"
#endif
...
// for DTV 1Seg Driver SPI porting - [START] 2011-05-20 taew00k.kang added 
#ifndef CONFIG_LGE_BROADCAST_DCM 
...
#endif
// for DTV 1Seg Driver SPI porting - [END]
...
#ifndef CONFIG_LGE_FELICA /* replace with felica_cen */
	{
		.gpio      = 123,
		.settings = {
...
static struct msm_gpiomux_config msm8x60_mi2s_configs[] __initdata = {
	/* MI2S WS */
// 2011-05-05 ella.hwang added for 1Seg Driver SPI porting - [Begins]
#ifndef CONFIG_LGE_BROADCAST_DCM   // GPIO 101~106 is used by DTV
	{
		.gpio = 101,
		.settings = {
...
#endif //CONFIG_LGE_BROADCAST_DCM
// 2011-05-05 ella.hwang added for 1Seg Driver SPI porting - [Ends]
...
// 2011-05-05 ella.hwang added for 1Seg Driver SPI porting - [Begins]
#ifndef CONFIG_LGE_BROADCAST_DCM	//GPIO 101~106 is used in DTV
	{
		.gpio = 105,
		.settings = {
			[GPIOMUX_ACTIVE]    = &cam_active_2_cfg,
...
#ifdef CONFIG_LGE_I_POWER_REVB_GPIO
struct msm_gpiomux_configs
msm8x60_p930_gpiomux_cfgs[] __initdata =
{
	{msm8x60_p930_gpio_configs, ARRAY_SIZE(msm8x60_p930_gpio_configs)},
};
#endif
/* kwangdo.yi@lge.com [jointlab] Wed 30 Mar 2011 E */
