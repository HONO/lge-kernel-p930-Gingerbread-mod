...
#endif
	.version	= 0x0100,
	.product_name		= "L-01D", //"LG Android USB Device",
...
#endif
//2011-05-05 ella.hwang added for 1Seg Driver SPI proting - [Ends]
	...
	struct pm8058_gpio_cfg gpio_cfgs[] = {
...
#ifdef CONFIG_MMC_MSM_CARD_HW_DETECTION
		{
			PMIC_GPIO_SDC3_DET - 1,
			{
                ...
                //20110512 hoyeon.jang@lge.com to detect external SD on Rev.A
				...
				.function		= PM_GPIO_FUNC_NORMAL,
                //20110512 hoyeon.jang@lge.com to detect external SD on Rev.A
				.inv_int_pol	= ((lge_bd_rev < LGE_REV_B) ? 1 : 0),
			},
		},
#endif
...
static const unsigned int i_dcm_revB_keymap[] = {
...
static struct matrix_keymap_data i_dcm_revB_keymap_data = {
	.keymap_size	= ARRAY_SIZE(i_dcm_revB_keymap),
	.keymap		= i_dcm_revB_keymap,
};

static struct pmic8058_keypad_data i_dcm_keypad_data = {
...
static struct pmic8058_keypad_data i_dcm_revB_keypad_data = {
	.input_name		= "i_dcm-keypad",
	.input_phys_device	= "i_dcm-keypad/input0",
	.num_rows		= 6,
	.num_cols		= 5,
	...
	.row_hold_ns            = 91500,
	.wakeup			= 1,
	.keymap_data		= &i_dcm_revB_keymap_data,
};
...
#if  defined(CONFIG_PM8058_CHARGER) || defined(CONFIG_LGE_SWITCHING_CHARGER_BQ24160_DOCOMO_ONLY)
...
#ifdef CONFIG_LGE_PMIC8058_REGULATOR //platform@lge.com : SD-card VDD shutdown@sleep
...
/* kwangdo.yi@lge.com [jointlab] Wed 30 Mar 2011 S
...
#else
static struct msm_board_data msm8x60_i_dcm_board_data __initdata = {
...
//2011-05-05 ella.hwang added for 1Seg Driver SPI porting - [Begins]
	...
	//platform_device_register(&msm_gsbi11_qup_spi_device); //blocking : msm_gsbi11_qup_spi_device is added in surf_devices[]
#endif
//2011-05-05 ella.hwang added for 1Seg Driver SPI porting - [Ends]
...
/* eunmo.yang@lge.com [BSP/Sensor] 20110623 END */
	...
	if(lge_bd_rev >= LGE_REV_B) {
		pm8058_platform_data.sub_devices[PM8058_SUBDEV_KPD].
			platform_data = &i_dcm_revB_keypad_data;
		pm8058_platform_data.sub_devices[PM8058_SUBDEV_KPD].data_size
			= sizeof(i_dcm_revB_keypad_data);
	}else{
		pm8058_platform_data.sub_devices[PM8058_SUBDEV_KPD].
			platform_data = &i_dcm_keypad_data;
		pm8058_platform_data.sub_devices[PM8058_SUBDEV_KPD].data_size
			= sizeof(i_dcm_keypad_data);
	}
#endif
...
*/
#ifdef CONFIG_LGE_I_POWER_REVB_GPIO
static void __init msm8x60_p930_init(void)
{
	msm8x60_board_init(&msm8x60_p930_board_data);
}
#else
static void __init msm8x60_i_dcm_init(void)
{
	msm8x60_board_init(&msm8x60_i_dcm_board_data);
}
#endif
/* kwangdo.yi@lge.com [jointlab] Wed 30 Mar 2011 E */
...
*/
#ifdef CONFIG_LGE_I_POWER_REVB_GPIO
	.init_machine = msm8x60_p930_init,
#else
