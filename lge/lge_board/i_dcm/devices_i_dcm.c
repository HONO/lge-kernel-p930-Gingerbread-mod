...
#ifdef CONFIG_LGE_FELICA
	CLK_8X60("gsbi_uart_clk", GSBI10_UART_CLK, "msm_serial_hsl.3", OFF),
#else
...
// 2011-05-27 hansun.lee Never! remove this line!!! [Begins]
// If you want, send mail to me. hansun.lee@lge.com
#ifdef CONFIG_LGE_FELICA
	CLK_8X60("gsbi_pclk",		GSBI10_P_CLK, "msm_serial_hsl.3", OFF),
#endif
// 2011-05-27 hansun.lee [Ends]
#ifdef CONFIG_LGE_SENSOR
