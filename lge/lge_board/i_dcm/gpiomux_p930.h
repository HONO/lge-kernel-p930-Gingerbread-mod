...
static struct gpiomux_setting msm_gpio70_cfg_active= /* IPC_UART_TX for gsbi10 */
{
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_8MA ,
	.pull = GPIOMUX_PULL_DOWN,
};
static struct gpiomux_setting msm_gpio70_cfg_suspend = /* IPC_UART_TX for gsbi10 */
{
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
};
static struct gpiomux_setting msm_gpio71_cfg_active= /* IPC_UART_RX for gsbi10 */
{
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_8MA ,
	.pull = GPIOMUX_PULL_DOWN,
};
static struct gpiomux_setting msm_gpio71_cfg_suspend = /* IPC_UART_RX for gsbi10 */
{
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
...
static struct msm_gpiomux_config msm8x60_p930_gpio_configs[] __initdata =
{
	...
	},
	{
		...
		.settings = 
		{
			[GPIOMUX_ACTIVE] = &msm_gpio70_cfg_active,
	...
	},
	{
		...
		.settings = 
		{
			[GPIOMUX_ACTIVE] = &msm_gpio71_cfg_active,
