...
*/
#include "gpiomux_i_atnt_rev.h"

//for atnt rock_bottom start
...
*/
struct msm_gpiomux_configs
msm8x60_i_atnt_rev_gpiomux_cfgs[] __initdata =
{
	{msm8x60_i_atnt_rev_gpio_configs, ARRAY_SIZE(msm8x60_i_atnt_rev_gpio_configs)},
	{NULL, 0},
};
