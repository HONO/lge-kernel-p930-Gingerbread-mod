...
#ifndef CONFIG_LGE_BROADCAST	//LGE_BROADCAST_I
...
#ifndef CONFIG_LGE_BROADCAST		//GPIO 101~107 is used in TDMB, by soo.seomoon@lge.com
...
#ifndef CONFIG_LGE_BROADCAST	// soo.seomon@lge.com gpio 101~107 are used in TDMB
	{
		.gpio = 105,
		.settings = {
			[GPIOMUX_ACTIVE]    = &cam_active_2_cfg,
