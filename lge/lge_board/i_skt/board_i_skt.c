...
#if 1 // yennie.kang 2011-05-04 skt rev A micro-sd detect
...
static const unsigned int i_skt_revB_keymap[] = {
	KEY(0, 0, KEY_VOLUMEUP),
	KEY(0, 1, KEY_VOLUMEDOWN),
};
...
static struct matrix_keymap_data i_skt_revB_keymap_data = {
	.keymap_size	= ARRAY_SIZE(i_skt_revB_keymap),
	.keymap		= i_skt_revB_keymap,
};

static struct pmic8058_keypad_data i_skt_keypad_data = {
...
static struct pmic8058_keypad_data i_skt_revB_keypad_data = {
	.input_name		= "i_skt-keypad",
	.input_phys_device	= "i_skt-keypad/input0",
	.num_rows		= 6,
	.num_cols		= 5,
	...
	.row_hold_ns            = 91500,
	.wakeup			= 1,
	.keymap_data		= &i_skt_revB_keymap_data,
};
	...
	if (status) {
		...
		if (!status){
			status = !(gpio_get_value_cansleep(
				PM8058_GPIO_PM_TO_SYS(PMIC_GPIO_SDC3_DET - 1)));
#if defined(CONFIG_LGE_PMIC8058_GPIO)
#if 0 // yennie.kang 2011-05-04 skt rev A micro-sd detect 
...
#else
static struct msm_board_data msm8x60_i_skt_board_data __initdata = {
...
/* eunmo.yang@lge.com [BSP/Sensor] 20110623 END */
	...
	if(lge_bd_rev >= LGE_REV_B) {
		pm8058_platform_data.sub_devices[PM8058_SUBDEV_KPD].
			platform_data = &i_skt_revB_keypad_data;
		pm8058_platform_data.sub_devices[PM8058_SUBDEV_KPD].data_size
			= sizeof(i_skt_revB_keypad_data);
	}else{
		pm8058_platform_data.sub_devices[PM8058_SUBDEV_KPD].
			platform_data = &i_skt_keypad_data;
		pm8058_platform_data.sub_devices[PM8058_SUBDEV_KPD].data_size
			= sizeof(i_skt_keypad_data);
	}
#endif
...
{
	msm8x60_board_init(&msm8x60_i_skt_board_data);
}
#endif
/* kwangdo.yi@lge.com [jointlab] Wed 30 Mar 2011 E */
