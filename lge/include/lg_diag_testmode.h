...
typedef union
{
    ...
    char					srd_resotre[133];//20110823	jungyub.jee@lge.com SRD Restore
} test_mode_req_type;
...
typedef union
{
    ...
    test_mode_req_XOCalDataBackup_Type XOCalDataBackup;
	char	srd_backup[133];//20110822 jungyub.jee@lge.com	SRD Backup
	byte NTCode[MAX_NTCODE_SIZE];
...
typedef enum
{
    ...
    //20110829 jungyub.jee@lge.com SRD Backup&Restore[Start]
    TEST_MODE_SRD_RESTORE = 101,
    TEST_MODE_SRD_BACKUP = 102,
    //20110829 jungyub.jee@lge.com SRD Backup&Restore[End]
